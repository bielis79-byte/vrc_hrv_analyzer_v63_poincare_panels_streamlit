...
st.set_page_config(page_title="VRC / HRV RRi Analyzer Pro v6.3 Kubios Mode", layout="wide")
...
st.title("VRC / HRV RRi Analyzer Pro v6.3 · Kubios Mode")
st.caption("Segmentación tipo Kubios, dominios, MSE, Poincaré en paneles, HVG comparativo e informe automático.")
